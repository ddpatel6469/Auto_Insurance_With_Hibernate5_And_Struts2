...
<body>
	<div style="padding: 15% 40% 10% 40%;width: 150%">
	<s:form method="post" action="loginadmin">
	<s:textfield label="Admin Name" placeholder="Name" name="ia.admin_name" class="form-control"/>
	<s:password label="Admin Password" placeholder="Password" name="ia.admin_password" class="form-control"/>
	<s:submit class="btn btn-success" value="Login"/>
	</s:form>
